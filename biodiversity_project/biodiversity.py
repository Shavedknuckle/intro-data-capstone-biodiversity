...
conservation_status_options = species.conservation_status.unique()

print conservation_status_options
...
conservation_status_count = species.groupby(['conservation_status'])\
...
mammal_bird_contingency = chi2_contingency(contingency)

print mammal_bird_contingency[1]
...
reptile_mammal_contingency = chi2_contingency(contingency2)

print reptile_mammal_contingency[1]
